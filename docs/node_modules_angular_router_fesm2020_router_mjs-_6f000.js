(self["webpackChunkEDControls"] = self["webpackChunkEDControls"] || []).push([["node_modules_angular_router_fesm2020_router_mjs-_6f000"],{
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! rxjs */ 213);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! rxjs */ 5828);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! rxjs */ 1635);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs/operators */ 2647);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs/operators */ 1133);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! rxjs/operators */ 5690);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! rxjs/operators */ 5670);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! rxjs/operators */ 522);
...
const activateRoutes = (rootContexts, routeReuseStrategy, forwardEvent) => (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(t => {
...
function prioritizedGuardValue() {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(obs => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.combineLatest)(obs.map(o => o.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.startWith)(INITIAL_VALUE)))).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.scan)((acc, list) => {
      let isPending = false;
    ...
    }, INITIAL_VALUE), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.filter)(item => item !== INITIAL_VALUE), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(item => isUrlTree(item) ? item : item === true), //
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1));
  });
}
/**
 * @license
...
function noMatch(segmentGroup) {
  return new rxjs__WEBPACK_IMPORTED_MODULE_12__.Observable(obs => obs.error(new NoMatch$1(segmentGroup)));
}

function absoluteRedirect(newTree) {
  return new rxjs__WEBPACK_IMPORTED_MODULE_12__.Observable(obs => obs.error(new AbsoluteRedirect(newTree)));
}

function namedOutletsRedirect(redirectTo) {
  return new rxjs__WEBPACK_IMPORTED_MODULE_12__.Observable(obs => obs.error(new Error(`Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`)));
}

function canLoadFails(route) {
  return new rxjs__WEBPACK_IMPORTED_MODULE_12__.Observable(obs => obs.error(navigationCancelingError(`Cannot load children because the guard of the route "path: '${route.path}'" returned false`)));
}
/**
...
class ApplyRedirects {
  ...
  apply() {
    ...
    const urlTrees$ = expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(rootSegmentGroup => {
      return this.createUrlTree(squashSegmentGroup(rootSegmentGroup), this.urlTree.queryParams, this.urlTree.fragment);
    }));
    return urlTrees$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)(e => {
  ...
  match(tree) {
    ...
    const mapped$ = expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(rootSegmentGroup => {
      return this.createUrlTree(squashSegmentGroup(rootSegmentGroup), tree.queryParams, tree.fragment);
    }));
    return mapped$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)(e => {
      if (e instanceof NoMatch$1) {
        throw this.noMatchError(e);
      }
  ...
  expandSegmentGroup(ngModule, routes, segmentGroup, outlet) {
    if (segmentGroup.segments.length === 0 && segmentGroup.hasChildren()) {
      return this.expandChildren(ngModule, routes, segmentGroup).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(children => new UrlSegmentGroup([], children)));
    }
  ...
  expandChildren(ngModule, routes, segmentGroup) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(childOutlets).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.concatMap)(childOutlet => {
      ...
      return this.expandSegmentGroup(ngModule, sortedRoutes, child, childOutlet).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(s => ({
        segment: s,
        outlet: childOutlet
      })));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.scan)((children, expandedChild) => {
      children[expandedChild.outlet] = expandedChild.segment;
      return children;
    }, {}), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_15__.last)());
  }
  ...
  expandSegment(ngModule, segmentGroup, routes, segments, outlet, allowRedirects) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(routes).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.concatMap)(r => {
      ...
      return expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)(e => {
        if (e instanceof NoMatch$1) {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.first)(s => !!s), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)((e, _) => {
      if (e instanceof rxjs__WEBPACK_IMPORTED_MODULE_17__.EmptyError || e.name === 'EmptyError') {
        if (noLeftoversInUrl(segmentGroup, segments, outlet)) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(new UrlSegmentGroup([], {}));
        }
  ...
  expandWildCardWithParamsAgainstRouteUsingRedirect(ngModule, routes, route, outlet) {
    ...
    return this.lineralizeSegments(route, newTree).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(newSegments => {
  ...
  matchSegmentAgainstRoute(ngModule, rawSegmentGroup, route, segments, outlet) {
    if (route.path === '**') {
      if (route.loadChildren) {
        const loaded$ = route._loadedConfig ? (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(route._loadedConfig) : this.configLoader.load(ngModule.injector, route);
        return loaded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(cfg => {
          route._loadedConfig = cfg;
          return new UrlSegmentGroup(segments, {});
        }));
      }

      return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(new UrlSegmentGroup(segments, {}));
    }
    ...
    return childConfig$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(routerConfig => {
      ...
      if (slicedSegments.length === 0 && segmentGroup.hasChildren()) {
        ...
        return expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(children => new UrlSegmentGroup(consumedSegments, children)));
      }

      if (childConfig.length === 0 && slicedSegments.length === 0) {
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(new UrlSegmentGroup(consumedSegments, {}));
      }
      ...
      return expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(cs => new UrlSegmentGroup(consumedSegments.concat(cs.segments), cs.children)));
    }));
  }
  ...
  getChildConfig(ngModule, route, segments) {
    if (route.children) {
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(new LoadedRouterConfig(route.children, ngModule));
    }

    if (route.loadChildren) {
      // lazy children belong to the loaded module
      if (route._loadedConfig !== undefined) {
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(route._loadedConfig);
      }

      return this.runCanLoadGuards(ngModule.injector, route, segments).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(shouldLoadResult => {
        if (shouldLoadResult) {
          return this.configLoader.load(ngModule.injector, route).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(cfg => {
            route._loadedConfig = cfg;
            return cfg;
          }));
        }
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(new LoadedRouterConfig([], ngModule));
  }

  runCanLoadGuards(moduleInjector, route, segments) {
    const canLoad = route.canLoad;
    if (!canLoad || canLoad.length === 0) return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(true);
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(canLoadObservables).pipe(prioritizedGuardValue(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.tap)(result => {
...
function applyRedirects(moduleInjector, configLoader, urlSerializer, config) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(t => applyRedirects$1(moduleInjector, configLoader, urlSerializer, t.extractedUrl, config).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(urlAfterRedirects => ({ ...t,
    urlAfterRedirects
  }))));
}
/**
...
function checkGuards(moduleInjector, forwardEvent) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(t => {
    const {
      targetSnapshot,
      currentSnapshot,
      guards: {
    ...
    return runCanDeactivateChecks(canDeactivateChecks, targetSnapshot, currentSnapshot, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(canDeactivate => {
      return canDeactivate && isBoolean(canDeactivate) ? runCanActivateChecks(targetSnapshot, canActivateChecks, moduleInjector, forwardEvent) : (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(canDeactivate);
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(guardsResult => ({ ...t,
      guardsResult
    })));
  });
}
...
function runCanDeactivateChecks(checks, futureRSS, currRSS, moduleInjector) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(check => runCanDeactivate(check.component, check.route, currRSS, futureRSS, moduleInjector)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.first)(result => {
    return result !== true;
  }, true));
}
...
function runCanActivateChecks(futureSnapshot, checks, moduleInjector, forwardEvent) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.concatMap)(check => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_20__.concat)(fireChildActivationStart(check.route.parent, forwardEvent), fireActivationStart(check.route, forwardEvent), runCanActivateChild(futureSnapshot, check.path, moduleInjector), runCanActivate(futureSnapshot, check.route, moduleInjector));
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.first)(result => {
    return result !== true;
  }, true));
}
/**
...
function runCanActivate(futureRSS, futureARS, moduleInjector) {
  ...
  const canActivateObservables = canActivate.map(c => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_21__.defer)(() => {
      ...
      return observable.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.first)());
    });
  });
...
function newObservableError(e) {
  ...
  return new rxjs__WEBPACK_IMPORTED_MODULE_12__.Observable(obs => obs.error(e));
}
...
function recognize(rootComponentType, config, serializer, paramsInheritanceStrategy, relativeLinkResolution) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(t => recognize$1(rootComponentType, config, t.urlAfterRedirects, serializer(t.urlAfterRedirects), paramsInheritanceStrategy, relativeLinkResolution).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(targetSnapshot => ({ ...t,
    targetSnapshot
  }))));
}
/**
...
function resolveData(paramsInheritanceStrategy, moduleInjector) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(t => {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(canActivateChecks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.concatMap)(check => runResolve(check.route, targetSnapshot, paramsInheritanceStrategy, moduleInjector)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.tap)(() => canActivateChecksResolved++), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(_ => canActivateChecksResolved === canActivateChecks.length ? (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t) : rxjs__WEBPACK_IMPORTED_MODULE_23__.EMPTY));
  });
}

function runResolve(futureARS, futureRSS, paramsInheritanceStrategy, moduleInjector) {
  const resolve = futureARS._resolve;
  return resolveNode(resolve, futureARS, futureRSS, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(resolvedData => {
...
function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
  ...
  const data = {};
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(keys).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(key => getResolver(resolve[key], futureARS, futureRSS, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.tap)(value => {
    data[key] = value;
  }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(() => {
...
class RouterConfigLoader {
  ...
  load(parentInjector, route) {
    ...
    const loadRunner = moduleFactory$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(factory => {
      ...
      return new LoadedRouterConfig(flatten(module.injector.get(ROUTES, undefined, _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectFlags.Self | _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectFlags.Optional)).map(standardizeConfig), module);
  ...
  loadModuleFactory(loadChildren) {
    return wrapIntoObservable(loadChildren()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(t => {
...
class Router {
  ...
  setupNavigations(transitions) {
    ...
    return transitions.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.filter)(t => t.id !== 0), // Extract URL
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(t => ({ ...t,
      extractedUrl: this.urlHandlingStrategy.extract(t.rawUrl)
    })), // Using switchMap so we cancel executing navigations when a new one comes in
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(t => {
      let completed = false;
      let errored = false;
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t).pipe( // Store the Navigation object
      (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.tap)(t => {
        ...
        if (processCurrentUrl) {
          ...
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t).pipe( // Fire NavigationStart event
          (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(t => {
      ...
      })), checkGuards(this.ngModule.injector, evt => this.triggerEvent(evt)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.tap)(t => {
      ...
      switchTap(t => {
        if (t.guards.canActivateChecks.length) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.tap)(t => {
            const resolveStart = new ResolveStart(t.id, this.serializeUrl(t.extractedUrl), this.serializeUrl(t.urlAfterRedirects), t.targetSnapshot);
            this.triggerEvent(resolveStart);
          }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(t => {
            let dataResolved = false;
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t).pipe(resolveData(this.paramsInheritanceStrategy, this.ngModule.injector), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.tap)({
      ...
      }), activateRoutes(this.rootContexts, this.routeReuseStrategy, evt => this.triggerEvent(evt)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.tap)({
        next() {
          completed = true;
        },
      ...
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)(e => {
...
RouterLinkWithHref.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineDirective"]({
  ...
  hostBindings: function RouterLinkWithHref_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵattribute"]("target", ctx.target)("href", ctx.href, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsanitizeUrl"]);
    }
  },
  inputs: {
    target: "target",
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](RouterLinkWithHref, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_1__.Directive,
    args: [{
...
class RouterLinkActive {
  ...
  ngAfterContentInit() {
    ...
    (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(this.links.changes, this.linksWithHrefs.changes, (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(null)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.mergeAll)()).subscribe(_ => {
      this.update();
  ...
  subscribeToEachLinkOnChanges() {
    ...
    this.linkInputChangesSubscription = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(allLinkChanges).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.mergeAll)()).subscribe(link => {
...
RouterLinkActive.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineDirective"]({
  ...
  contentQueries: function RouterLinkActive_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵcontentQuery"](dirIndex, RouterLinkWithHref, 5);
    }
...
class PreloadAllModules {
  preload(route, fn) {
    return fn().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(null)));
  }
...
class RouterPreloader {
  ...
  processRoutes(ngModule, routes) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(res).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.mergeAll)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(_ => void 0));
  }

  preloadConfig(ngModule, route) {
    return this.preloadingStrategy.preload(route, () => {
      const loaded$ = route._loadedConfig ? (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(route._loadedConfig) : this.loader.load(ngModule.injector, route);
      return loaded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(config => {
...
const ROUTER_PROVIDERS = [_angular_common__WEBPACK_IMPORTED_MODULE_0__.Location, {
  provide: UrlSerializer,
  useClass: DefaultUrlSerializer
}, {
  provide: Router,
  useFactory: setupRouter,
  deps: [UrlSerializer, ChildrenOutletContexts, _angular_common__WEBPACK_IMPORTED_MODULE_0__.Location, _angular_core__WEBPACK_IMPORTED_MODULE_1__.Injector, _angular_core__WEBPACK_IMPORTED_MODULE_1__.Compiler, ROUTES, ROUTER_CONFIGURATION, [UrlHandlingStrategy, new _angular_core__WEBPACK_IMPORTED_MODULE_1__.Optional()], [RouteReuseStrategy, new _angular_core__WEBPACK_IMPORTED_MODULE_1__.Optional()]]
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](RouterInitializer, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_1__.Injectable
  }], function () {
    return [{
      type: _angular_core__WEBPACK_IMPORTED_MODULE_1__.Injector
...
//# sourceMappingURL=node_modules_angular_router_fesm2020_router_mjs-_6f000.js.map